...
#[Title('Lista de cupones por categoría')]
class CuponCategoriaComponent extends Component
{
    use WithPagination;
    public $search='';
    ...
    {
        $cupones = Cupones::whereHas('categorias', function($query) {
        ...
        return view('livewire.cupon.cupon-categoria-component', [
    ...
    {
        $this->reset([
            'nombre', 'Id', 'descuento', 'fecha_vencimiento', 'categoria_id'
        ]);
        $this->resetErrorBag();
    }
